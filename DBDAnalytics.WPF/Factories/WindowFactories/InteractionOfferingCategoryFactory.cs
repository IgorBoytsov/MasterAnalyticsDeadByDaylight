...
{
    internal class InteractionOfferingCategoryFactory(Func<InteractionOfferingCategoryVM> viewModelFactory) : IWindowFactory
    {
        private readonly Func<InteractionOfferingCategoryVM> _viewModelFactory = viewModelFactory;
        ...
        public Window CreateWindow(object parameter = null, TypeParameter typeParameter = TypeParameter.None)
        {
            ...
            return new InteractionOfferingCategoryWindow
            {
