...
{
    internal class InteractionSurvivorPerkCategoryFactory(Func<InteractionSurvivorPerkCategoryVM> viewModelFactory) : IWindowFactory
    {
        private readonly Func<InteractionSurvivorPerkCategoryVM> _viewModelFactory = viewModelFactory;
        ...
        public Window CreateWindow(object parameter = null, TypeParameter typeParameter = TypeParameter.None)
        {
            ...
            return new InteractionSurvivorPerkCategoryWindow
            {
