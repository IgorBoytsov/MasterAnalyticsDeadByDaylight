...
{
    class PreviewMatchFactory(Func<PreviewMatchVM> viewModelFactory) : IWindowFactory
    {
        private readonly Func<PreviewMatchVM> _viewModelFactory = viewModelFactory;
