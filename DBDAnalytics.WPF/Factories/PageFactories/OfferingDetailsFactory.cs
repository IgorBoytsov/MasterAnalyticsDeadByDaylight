...
{
    internal class OfferingDetailsFactory(Func<OfferingDetailsVM> viewModel) : IPageFactory
    {
        private readonly Func<OfferingDetailsVM> _viewModelFactory = viewModel;
