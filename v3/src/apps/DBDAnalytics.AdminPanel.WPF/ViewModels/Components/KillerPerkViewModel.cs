...
namespace DBDAnalytics.AdminPanel.WPF.ViewModels.Components
{
    internal sealed class KillerPerkViewModel(KillerPerkResponse model) : ObservableObject<KillerPerkResponse>(model)
    {
        ...
        private KillerPerkCategoryResponse? _category;
        public KillerPerkCategoryResponse? Category
        {
            get => _category;
        ...
        public bool HasChanges
        {
            get
            {
                ...
                bool killerImageChanged = !(_originalImageBytes ?? []).SequenceEqual(currentImageBytes ?? []);
        ...
        public override void CommitChanges(KillerPerkResponse newModel)
        {
        ...
        public override KillerPerkResponse ToModel()
            => _model with
            {
                OldId = this.OldId,
                Name = this.Name
