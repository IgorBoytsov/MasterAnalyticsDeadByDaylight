...
{
    internal sealed class SurvivorPerkCategoryViewModel(SurvivorPerkCategoryResponse model) : ObservableObject<SurvivorPerkCategoryResponse>(model)
    {
        ...
        public override SurvivorPerkCategoryResponse ToModel()
            => _model with
            {
                OldId = this.OldId,
                Name = this.Name
