...
{
    internal sealed class KillerPerkCategoryViewModel(KillerPerkCategoryResponse model) : ObservableObject<KillerPerkCategoryResponse>(model)
    {
        ...
        public override KillerPerkCategoryResponse ToModel()
            => _model with
            {
                OldId = this.OldId,
                Name = this.Name
