...
{
    internal sealed class WhoPlacedMapViewModel(WhoPlacedMapResponse model) : ObservableObject<WhoPlacedMapResponse>(model)
    {
        ...
        public override WhoPlacedMapResponse ToModel()
            => _model with
            {
                OldId = this.OldId,
                Name = this.Name
