...
{
    internal sealed class PlayerAssociationViewModel(PlayerAssociationResponse model) : ObservableObject<PlayerAssociationResponse>(model)
    {
        ...
        public override PlayerAssociationResponse ToModel()
            => _model with
            {
                OldId = this.OldId,
                Name = this.Name
