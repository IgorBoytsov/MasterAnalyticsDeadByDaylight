...
{
    public sealed class MeasurementMapApiService(HttpClient httpClient, string measurementsId)
        : BaseApiService<MapResponse, string>(httpClient, $"api/measurements/{measurementsId}/maps"), IMeasurementMapApiService
    {
