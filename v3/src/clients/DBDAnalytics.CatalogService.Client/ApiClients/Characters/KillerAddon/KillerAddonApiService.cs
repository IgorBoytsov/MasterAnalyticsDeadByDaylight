...
{
    public sealed class KillerAddonApiService(HttpClient client, string killerId) 
        : BaseApiService<KillerAddonResponse, string>(client, $"api/killers/{killerId}/addons"), IKillerAddonService
    {
        public async Task<Result<string>> UpdateAsync(ClientUpdateKillerAddonRequest request)
        {
