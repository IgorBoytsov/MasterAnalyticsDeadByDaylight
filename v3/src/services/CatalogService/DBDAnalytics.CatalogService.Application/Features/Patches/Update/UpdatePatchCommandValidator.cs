...
{
    public sealed class UpdatePatchCommandValidator : AbstractValidator<UpdatePatchCommand>
    {
        private readonly IPatchRepository _patchRepository;

        public UpdatePatchCommandValidator(IPatchRepository patchRepository)
        {
            _patchRepository = patchRepository;

            Include(new NameValidator<UpdatePatchCommand>(PatchName.MAX_LENGTH));
