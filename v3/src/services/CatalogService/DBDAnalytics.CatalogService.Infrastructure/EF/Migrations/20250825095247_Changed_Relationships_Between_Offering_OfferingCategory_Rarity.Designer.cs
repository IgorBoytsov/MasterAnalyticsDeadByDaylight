...
namespace DBDAnalytics.CatalogService.Infrastructure.EF.Migrations
{
    ...
    [Migration("20250825095247_Changed_Relationships_Between_Offering_OfferingCategory_Rarity")]
    partial class Changed_Relationships_Between_Offering_OfferingCategory_Rarity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DBDAnalytics.CatalogService.Domain.Models.KillerPerk", b =>
                {
                    b.HasOne("DBDAnalytics.CatalogService.Domain.Models.KillerPerkCategory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DBDAnalytics.CatalogService.Domain.Models.Offering", b =>
                {
                    b.HasOne("DBDAnalytics.CatalogService.Domain.Models.OfferingCategory", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("DBDAnalytics.CatalogService.Domain.Models.Rarity", null)
                        .WithMany()
                        .HasForeignKey("RarityId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("DBDAnalytics.CatalogService.Domain.Models.Role", null)
                        .WithMany()
