...
{
    internal class InteractionWhoPlacedMapFactory(Func<InteractionWhoPlacedMapVM> viewModelFactory) : IWindowFactory
    {
        private readonly Func<InteractionWhoPlacedMapVM> _viewModelFactory = viewModelFactory;
        ...
        public Window CreateWindow(object parameter = null, TypeParameter typeParameter = TypeParameter.None)
        {
            ...
            return new InteractionWhoPlacedMapWindow
            {
