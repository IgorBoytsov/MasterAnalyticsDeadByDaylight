...
{
    internal class InteractionKillerFactory(Func<InteractionKillerVM> viewModelFactory) : IWindowFactory
    {
        private readonly Func<InteractionKillerVM> _viewModelFactory = viewModelFactory;
        ...
        public Window CreateWindow(object parameter = null, TypeParameter typeParameter = TypeParameter.None)
        {
            ...
            return new InteractionKillerWindow
            {
