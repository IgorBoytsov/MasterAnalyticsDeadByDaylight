...
{
    internal class InteractionAssociationFactory(Func<InteractionAssociationVM> viewModelFactory) : IWindowFactory
    {
        private readonly Func<InteractionAssociationVM> _viewModelFactory = viewModelFactory;
        ...
        public Window CreateWindow(object parameter = null, TypeParameter typeParameter = TypeParameter.None)
        {
            ...
            return new InteractionAssociationWindow
            {
