...
namespace DBDAnalytics.WPF.ViewModels.WindowVM
{
    internal class AddMatchVM : BaseVM, IUpdatable
    {
        ...
        public bool ResetKillerPerks { get; set; } = false;
        
        public bool ResetKillerAddons { get; set; } = false;

        public bool ResetKillerOffering { get; set; } = false;

        public bool ResetKillerPrestige { get; set; } = false;

        public bool ResetSurvivorPerks { get; set; } = false;
        ...
        public RelayCommand LoadEndMatchImageCommand 
        { 
            get => _loadEndMatchImageCommand ??= new(obj =>
            { 
                if (SelectedImagePath != null)
                {
                    CropEndMatchImage();
        ...
        {
            ResultMatchKillerImage =         ImageHelper.GetBitmapImage(ImageHelper.CropImage(SelectedImagePath.PathImage, 70, 935, 920, 125));
            ResultMatchFirstSurvivorImage =  ImageHelper.GetBitmapImage(ImageHelper.CropImage(SelectedImagePath.PathImage, 70, 425, 920, 125));
            ResultMatchSecondSurvivorImage = ImageHelper.GetBitmapImage(ImageHelper.CropImage(SelectedImagePath.PathImage, 70, 550, 920, 125));
            ResultMatchThirdSurvivorImage =  ImageHelper.GetBitmapImage(ImageHelper.CropImage(SelectedImagePath.PathImage, 70, 680, 920, 125));
            ResultMatchFourthSurvivorImage = ImageHelper.GetBitmapImage(ImageHelper.CropImage(SelectedImagePath.PathImage, 70, 810, 920, 125));
            ResultMatchImage =               ImageHelper.GetBitmapImage(ImageHelper.CropImage(SelectedImagePath.PathImage, 70, 200, 980, 850));
        }
        ...
        private void AddGameStatistic()
        {
            ...
            //byte[] ResultMatchByteArray = ImageHelper.BitmapImageToByteArray(ResultMatchImage);
            byte[] ResultMatchByteArray = null;
