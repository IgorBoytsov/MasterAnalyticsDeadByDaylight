...
namespace DBDAnalytics.WPF
{
    public partial class App : System.Windows.Application
    {
        ...
        private static void ConfigureWindow(ServiceCollection services)
        {
            ...
            services.AddTransient<IWindowFactory, ComparisonHubFactory>();
            services.AddTransient<ComparisonHubVM>();
            services.AddSingleton<Func<ComparisonHubVM>>(provider => () => provider.GetRequiredService<ComparisonHubVM>());            
